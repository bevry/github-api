...
``` html
<script type="module">
    import * as pkg from '//cdn.skypack.dev/githubauthreq@^6.1.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//unpkg.com/githubauthreq@^6.1.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//dev.jspm.io/githubauthreq@6.1.0'
</script>
```
